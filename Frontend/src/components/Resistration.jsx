...
const Registration = () => {
  ...
  console.log('tocken form localStorage',token);
      ...
      >
        <Fade in={openPreview}>
          <Box className="absolute h-[100vh] w-[100vw] overflow-y-scroll md:py-20 py-16 ">
            {token?<div className=" sm:h-60 sm:max-w-72 max-w-60 h-40 mx-auto mt-40 rounded-md relative flex flex-col justify-center items-center sm:gap-5 border bg-[#09090943] dark:bg-[#bdbdbd48] animate__animated animate__bounceIn" style={{borderColor:color}}>
              ...
              <div className="absolute top-1 right-1 hover:cursor-pointer">
                  ...
                  <CheckCircleOutlinedIcon  sx={{width:'100px',height:'100px',color:color}}  />
                  <div className="sm:text-2xl text-lg font-bold hover:cursor-default " style={{color:color}}>Succefully Submited</div>
              ...
              >
                ...
                <div className=" w-full flex justify-evenly  items-center h-20">
                  ...
                  {isTicked ? (
                    <Button
                      variant="contained"
                      onClick={sendDataToBackendHandler}
                    >
                      submit
                    </Button>
                  ) : (
