...
function StudentProfile() {
  ...
  return (
    <div className=" flex lg:flex-row flex-col lg:w-[95vw] lg:gap-5 gap-3 md:w-[70vw] sm:w-[80vw] w-[95vw] m-auto text-slate-800 dark:text-slate-200 ">
      <div className="lg:sticky  lg:top-28 lg:w-[25vw] w-full mt-10 lg:mt-0 h-fit bg-slate-200/50 dark:bg-slate-700/50 lg:rounded-lg rounded-md border-[1px] border-slate-500 duration-200 p-5 flex flex-col items-center gap-2">
      ...
      <div
        className="lg:w-[50vw] w-full lg:my-8 py-7 px-2 bg-slate-200/50 lg:rounded-lg rounded-md  dark:bg-slate-700/50 flex  flex-col   border-[1px] duration-200"
     ...
     <div className="grid sm:grid-cols-2 sm:grid-rows-6 grid-cols-1 grid-rows-11 gap-4 m-auto">
      ...
      <div className="lg:sticky lg:top-28  lg:w-[25vw] h-[50vh] w-full bg-slate-200/50 dark:bg-slate-700/50 lg:rounded-lg rounded-md border-[1px] border-slate-500 duration-200"></div>
